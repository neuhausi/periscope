...
This generates a default sample application optionally with a right sidebar in a subdirectory named *mytestapp* 
...
This generates a default blank application optionally with a right sidebar in a subdirectory named *mytestapp* 
at the specified location.  The location must exist when calling this function.
