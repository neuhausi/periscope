...
instance: csv/tsv/xlsx types require data that is convertable to a tabular type,
tiff requires a tiff class object, etc.  For more information on convertions of data 
